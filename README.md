...
Once you have git installed, clone this repository by running **git clone https://github.com/SIGNLL-UIUC/SIGNLL-Fall-2022**. You should now have a local directory of this repository!
